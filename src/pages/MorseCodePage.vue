<template>
  <f7-page name="PredictingPage">
    <div class="morse-code-page">
        <h3 class="morse-code-page__title">Morse Code</h3>
        <p class="morse-code-page__description">Morse Code encodes text characters as standardized sequences of two different signal durations.</p>
        <img class="morse-code-page__img" src="../static/images/morse-code.png" alt="morse-code-table">
